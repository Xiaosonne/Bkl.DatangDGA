...
public partial class DGAService : BackgroundService
{
    ...
    private Channel<ChannelData<AlarmService, AlarmServiceFeatureGas[]>> _gasAlarmSource;
    ...
    public DGAService(Channel<ChannelData<DGAService, DeviceState[]>> devicequeue,
                 Channel<ChannelData<AlarmService, AlarmServiceFeatureGas[]>> gasAlarmSource,
            ...
            try
            {
                ...
                try
                {
                    ...
                    var featureGas = ana.YearsGasData.Select(s =>
                    {
                        ...
                        .ToArray();
                    await _gasAlarmSource.Writer.WriteAsync(new ChannelData<AlarmService, AlarmServiceFeatureGas[]>
                    {
                        Data = featureGas
                    });
                }
