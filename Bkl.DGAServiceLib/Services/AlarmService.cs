...
public class AlarmService : BackgroundService
{
    ...
    private Channel<ChannelData<AlarmService, AlarmServiceFeatureGas[]>> _channel;
    private IConfiguration _config;
    private ILogger<AlarmService> _logger;
    static IEnumerable<BklAnalysisRule> _analysisRules;
    static IEnumerable<BklDeviceMetadata> _deviceList;
    private readonly object _lock = new object();

    public AlarmService(ServiceLibOption<DGAService> config,
        ILogger<AlarmService> logger,
        IServiceProvider serviceProvider, Channel<ChannelData<AlarmService, AlarmServiceFeatureGas[]>> channel)
    {
